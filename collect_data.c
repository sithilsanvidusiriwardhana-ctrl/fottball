...
void saveJson(const char *filename, Match matches[], int *match_count, Player players[], int *player_count) {
    if (*match_count == 0) {
        ...
        switch(choice) {
            case 1:
                ...
                if (input) {
                    ...
                    printf("✗ matches_input.csv not found or already loaded.\n");
                }
                ...
                if (players_input) {
                    ...
                    printf("✗ players_input.csv not found or already loaded.\n");
                }
                break;
            ...
            case 4:
                saveJson("data.json", matches, &match_count, players, &player_count);
                if (input) fclose(input);
                if (players_input) fclose(players_input);
                return EXIT_SUCCESS;
